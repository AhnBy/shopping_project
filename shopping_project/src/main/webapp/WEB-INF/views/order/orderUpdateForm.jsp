...
<body>
	...
	<div class="container">
		...
		<c:set value="${orderList}" var="dto"/>
		<c:set value="2500" var="del_fee"/>
		<div class="row qnas" style="text-align: center;">
			<h1 class="page-header">주문 수정하기</h1>
			<table class="table table-hover" style="width: 70%; margin: auto; border-bottom: 1px solid #D5D5D5;">
				...
				<tbody>
						<tr>
							<td><img src="https://github.com/AhnBy/shopping_project/blob/master/img/${dto.fullname}?raw=true/" width="100px" height="100px">
							<input type="hidden" value="${dto.fullname}" name="fullname">
							...
							<td><select name="orderQty" class="form-control order_Qty">
									<option value="${dto.orderQty}" >${dto.orderQty}</option>
								<c:forEach begin="1" end="5" var="stock">
		...
		<c:set value="${result}" var="vo"/>
			<h1 class="page-header">주문정보 수정하기</h1>
			<h4 style="color: red;">주문자 정보와 배송지가 변경된 경우 재입력해주세요.</h4>
		</div>
		<div class="row">
			...
			<div class="row" style="text-align: center; margin: 80px 0;">
				<h1 class="page-header">결제수단 수정하기</h1>
