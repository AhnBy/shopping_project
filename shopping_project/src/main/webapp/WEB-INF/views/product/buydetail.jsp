...
<script type="text/javascript">
	$(function() {
		...
		$('#cartMove').on('click', function() {
			...
			var opt = $(".opt_select").val();
			location.href = "/cart/add?userid="+userid+"&productId="+productId+"&selected_Opt="+opt+"&order_Qty="+count;
		});
		...
		<div class="row productInfo" style="width: 40%; float: right;" >
			...
			<div class="row">
				...
				<div style="text-align: center;">
					...
					<button type="button" id="cartMove" class="btn btn-default btn-cart">장바구니</button>
				</div>
			</div>
			<hr>	
		</div>
