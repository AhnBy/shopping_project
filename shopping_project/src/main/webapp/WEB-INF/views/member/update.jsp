...
<body>
	...
	<h2 class="col-sm-offset-2 col-sm-10">회원정보 수정</h2>
	<label class="col-sm-offset-2 col-sm-10">(<span id="need">*</span> 필수입력사항)</label>
	  <form class="form-horizontal" 
	    ...
	    <div class="form-group">
	      ...
	      <div class="col-sm-4">          
	        <input type="password" class="form-control" id="userpw" value="${result.userpw}"  name="userpw">
	      </div>
	    </div>
	    <div class="form-group">
	      <label class="control-label col-sm-2" for="repasswd"><span id="need">*</span>비밀번호 확인</label>
	      <div class="col-sm-4">          
	        <input type="password" class="form-control" id="repasswd" value="${result.userpw}"  name="repasswd">
	      </div>
	    </div>
	    <div class="form-group">
	      <label class="control-label col-sm-2" for="name"><span id="need">*</span>이름</label>
	      <div class="col-sm-4">          
	    ...
	    <div class="form-group">
	      ...
	      <div class="col-sm-4">          
	        <input type="date" class="form-control" id="birth" name="birthDate" value="${result.birthDate}">
	      </div>
	    </div>
	    <div class="form-group">
	      <label class="control-label col-sm-2" for="tel"><span id="need">*</span>전화번호</label>
	      <div class="col-sm-4">          
	        <input type="text" class="form-control" id="tel" value="${result.tel}"  name="tel">
	      </div>
	    </div>
	    <div class="form-group">
	    ...
	    <div class="form-group">
	      ...
	      <div class="col-sm-1">          
	        <input type="text" class="form-control" name="zipcode" id="sample6_postcode" value="${result.zipcode}">
	      </div>
	    ...
	    <div class="form-group">
	      ...
	      <div class="col-sm-6">          
	        <input type="text" class="form-control" id="sample6_address" value="${result.address1}" name="address1">
	        <input type="text" class="form-control" id="sample6_detailAddress" value="${result.address2}" name="address2">
	      </div>
	    </div>
	    <div class="form-group">        
	      <div class="col-sm-offset-2 col-sm-5">
	        <button type="submit" class="btn btn-default">수정</button>
	        <button type="button" class="btn btn-default" onclick="location='/member/myPage?userid=${result.userid}'">마이페이지로 돌아가기</button>
	      </div>
	    </div>
	  </form>
	<br><br>
